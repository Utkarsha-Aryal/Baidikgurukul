                ...
                @foreach ($images as $image)
                    <div class="g-inner-img">
                        @if (!empty($image->image) && Storage::exists('public/gallery-image/' . $image->image))
                            <img src="{{ asset('storage/gallery-image/' . $image->image) }}" alt="Gallery Image"
                                data-src="{{ asset('storage/gallery-image/' . $image->image) }}">
                        @else
                            <img src="{{ asset('frontpanel/assets/images/placeholder.png') }}" alt="Default Image"
                                data-src="{{ asset('frontpanel/assets/images/placeholder.png') }}">
                        @endif
                    </div>
                @endforeach
            </div>
