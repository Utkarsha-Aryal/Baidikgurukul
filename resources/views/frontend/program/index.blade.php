    ...
    <div class="container">
        <div class="program-content">
            <div class="program-r1">
                <div class="r1-img">
                    <img src="frontend\images\Rectangle 148 (2).png" alt="image">
                </div>
                <div class=" program-r1-title">
                    <p>Completed projects Completed of projects overview</p>
                </div>
            ...
            <div class="program-r1">
                <div class="r1-img">
                    <img src="frontend\images\Rectangle 170 (3).png" alt="">
                </div>
                <div class="program-r1-title">
                    <p>Completed projects Completed of projects overview</p>
                </div>
