                ...
                <div class="nb_right_container">
                    ...
                    <div class="nb_right_wrapper">
                        <div class="right_calender">
                            ...
                            <p>Date: <span class="grey_txt">{{ $event->event_date->format('M d, Y') }}</span>
                            </p>
                        </div>
                    </div>
                    <div class="nb_right_wrapper">
                        <div class="right_calender">
                            ...
                            <p>Time: <span class="grey_txt">{{ $event->event_time_start ?? '' }} -
                    ...
                    <div class="nb_right_wrapper">
                        <div class="right_calender">
                            ...
                            <p>Venue: <span class="grey_txt">{{ $event->venue ?? '' }}</span> </p>
                        </div>
                    </div>
                    <div class="nb_right_wrapper">
                        <div class="right_calender">
                            ...
                            <p>Address: <span class="grey_txt">{{ $event->address ?? '' }}</span> </p>
                        </div>
                    </div>
                </div>
            </div>
