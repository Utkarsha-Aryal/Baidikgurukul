...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('admin.sitesetting.update') }}" id="site-setting-form" enctype="multipart/form-data">
            <div class="row">
                <div class="form-group col-4">
                    <label for="inputEmail4">Organization Name <span class="required-field">*</span></label>
                    <input type="text" class="form-control mt-1" id="name" name="name" value="{{ isset($siteSettings) ? $siteSettings['name'] : old('name') }}" placeholder="Enter school name">
                </div>
                <div class="form-group col-4">
                    <label for="email">Email </label>
                    <input type="email" class="form-control mt-1" id="email" name="email" value="{{ $siteSettings['email'] }}" placeholder="Enter email">
                </div>
                <div class="form-group col-4">
                    <label for="phone_number">Phone Number</label>
                    <input type="numper" class="form-control mt-1" id="phone_number" name="phone_number" value="{{ $siteSettings['phone_number'] }}" placeholder="Enter phone number">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-4">
                    ...
                    <input type="text" class="form-control mt-1" id="address" name="address" value="{{ $siteSettings['address'] }}" placeholder="Enter address">
                </div>
                <div class="form-group col-4">
                    <label for="link_facebook">Facebook Link</label>
                    <input type="text" class="form-control mt-1" id="facebook" name="link_facebook" value="{{ $siteSettings['link_facebook'] }}" placeholder="Enter facebook link">
                </div>
                <div class="form-group col-4">
                    <label for="link_instagram">Instagram Link</label>
                    <input type="text" class="form-control mt-1" id="instagram" name="link_instagram" value="{{ $siteSettings['link_instagram'] }}" placeholder="Enter instagram link">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-4">
                    ...
                    <input type="text" class="form-control mt-1" id="twitter" name="link_twitter" value="{{ $siteSettings['link_twitter'] }}" placeholder="Enter twitter link">
                </div>
                        ...
                        <div class="form-group col-6">
                            <div class="main-profile-overview">
                                <div class="img-rectangle">
                                    ...
                                    <input type="hidden" class="form-control croppedImgFavicon" id="croppedImgFavicon" name="croppedImgFavicon">
                                    @php
                        ...
                        <div class="form-group col-6">
                            <div class="main-profile-overview">
                                <div class="main-img-user profile-user user-profile">
                                    ...
                                    <input type="file" id="input_logo" class="input_logo" style="position: absolute; clip: rect(0, 0, 0, 0); pointer-events: none;" accept="image/*" name="img_logo">
                                    <input type="hidden" class="form-control croppedImg" id="croppedImg" name="croppedImg">
                                    <input type="hidden" class="form-control croppedImgFavicon" id="croppedImgFavicon" name="croppedImgFavicon">
                                    @php
                                    ...
                                    <img aorganizationlt="" src="{{ asset('/storage/setting') . '/' . $siteSettings['img_logo'] }}" alt="img" id="img_logo">
                                    @else
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            <div class="main-profile-overview">
                                <div class="main-img-user profile-user user-profile">
                                    <a>
                                        <label for="input_favicon" class="fe fe-camera profile-edit text-primary"></label>
                                        <input type="file" id="input_favicon" class="input_favicon" style="position: absolute; clip: rect(0, 0, 0, 0); pointer-events: none;" accept="image/*" name="img_favicon">
                                        @php
                                        $imagePath = 'setting/' . $siteSetting->img_favicon;
                                        @endphp
                                        @if (!empty($siteSetting->img_favicon) && Storage::exists('public/' . $imagePath))
                                        <img alt="" src="{{ asset('/storage/setting') . '/' . $siteSettings['img_favicon'] }}" alt="img" id="img_favicon">
                                        @else
                                        <img src="{{ asset('/no-image.jpg') }}" alt="Default Image" id='img_favicon'>
                                        @endif
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="preview" id="crop-preview"></div>
                                ...
                                <div class="col-md-12 mt-3">
                                    <button class="btn btn-primary" id="rotateLeft" title="Rotate 45 deg. Left"><i class="fa fa-undo"></i></button>
                                    <button class="btn btn-primary" id="rotateRight" title="Rotate 45 deg. Right"><i class="fa fa-redo"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
