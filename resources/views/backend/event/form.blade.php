    ...
    <form action="{{ route('admin.event.save') }}" method="POST" id="eventForm" enctype="multipart/form-data">
        ...
        <div class="row mt-2">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 datepick">
                <label for="event_date" class="form-label">Starting Time <span class="required-field">*</span></label>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                <label for="title" class="form-label">Ending Time <span class="required-field">*</span></label>
