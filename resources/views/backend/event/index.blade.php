    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        ...
        <div class="d-flex my-xl-auto right-content">
            <div class="pe-1 mb-xl-0">
                <button type="button" class="btn btn-primary addEvent" data-bs-toggle="modal" data-bs-target="#add"><i
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.addEvent').on('click', function(e) {
                e.preventDefault();
                var url = '{{ route('admin.event.form') }}';
            ...
            $(document).on('click', '.delete', function() {
                ...
                Swal.fire({
                    title: type === "nottrashed" ? "Are you sure you want to delete this event" :
                        "Are you sure you want to delete permanently  this event",
                    ...
                    if (result.isConfirmed) {
                        ...
                        var url = '{{ route('admin.event.delete') }}';
                        $.post(url, data, function(response) {
            ...
            $(document).on('click', '.restore', function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        var url = '{{ route('admin.event.restore') }}';
                        $.post(url, data, function(response) {
                            if (response) {
