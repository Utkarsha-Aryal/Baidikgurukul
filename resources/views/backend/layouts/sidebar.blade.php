...
<aside class="app-sidebar sticky" id="sidebar">
    ...
    <div class="main-sidebar-header">
        <a href="{{ route('admin.dashboard') }}" class="header-logo">
            <?php
            $imgPath = !empty($siteSetting->img_logo) && \Illuminate\Support\Facades\Storage::exists('public/setting/' . $siteSetting->img_logo)
                ? asset('storage/setting/' . $siteSetting->img_logo)
                : asset('no-image.jpg');
            ?>
            ...
            <ul class="main-menu">
                ...
                <li class="slide">
                    <a href="{{ route('admin.sitesetting') }}" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" width="16" height="16" fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
                ...
                <li class="slide">
                    <a href="{{ route('admin.message') }}" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Message From Member</span>
                    </a>
                </li>
                <li class="slide">
                ...
                <li class="slide">
                    <a href="{{ route('admin.service') }}" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" width="16" height="16" viewBox="0 0 32 32">
                            <path fill="currentColor" d="M26 20a2.97 2.97 0 0 0-1.855.66L22 19.423v-1.606a3 3 0 1 0-2 0v1.606l-2.145 1.239A2.97 2.97 0 0 0 16 20a3.02 3.02 0 1 0 2.925 2.353L21 21.155l2.075 1.198A2.998 2.998 0 1 0 26 20m-10 4a1 1 0 1 1 1-1a1 1 0 0 1-1 1m5-10a1 1 0 1 1-1 1a1 1 0 0 1 1-1m5 10a1 1 0 1 1 1-1a1 1 0 0 1-1 1" />
                            <path fill="currentColor" d="M16 31A11.013 11.013 0 0 1 5 20V6.382l10.987-5.5l10.46 5.237l-.895 1.788l-9.565-4.789L7 7.618V20a9 9 0 0 0 14.4 7.201l1.2 1.599A10.908 10.908 0 0 1 16 31" />
                        </svg>
                ...
                <li class="slide">
                    <a href="{{ route('admin.testimonial') }}" class="side-menu__item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" width="16" height="16" fill="currentColor" class="bi bi-megaphone" viewBox="0 0 16 16">
