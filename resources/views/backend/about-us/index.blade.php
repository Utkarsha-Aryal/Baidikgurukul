                    ...
                    <div class="row mt-2">
                        <div class="relative" id="edit-image">
                            <div class="profile-user">
                                <label for="edit_img_introduction" class="fe fe-camera profile-edit text-primary absolute"></label>
                            </div>
                            <input type="file" class="edit_img_introduction" id="edit_img_introduction" style="position: absolute; clip: rect(0, 0, 0, 0); pointer-events: none;" accept="image/*" name="img_introduction">
                            <input type="hidden" class="form-control croppedImgIntroduction" id="croppedImgIntroduction" name="croppedImgIntroduction">
                            <div class="img-rectangle">
                                @if (!empty($aboutusData['img_introduction']))
                                <img alt="" src={{ asset('/storage/aboutus') . '/' . @$aboutusData['img_introduction'] }} alt="img" id="img_introduction">
                                @else
